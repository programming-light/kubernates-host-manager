    ...
    <div className="min-h-screen bg-gray-950">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              <div
                key={feature.title}
                className="group rounded-xl border border-gray-800 bg-gray-900/50 p-6 transition-all duration-300 hover:border-gray-700 hover:bg-gray-900"
              >
      ...
      <footer className="border-t border-gray-800 bg-gray-900/50 px-6 py-12">
        <div className="mx-auto max-w-6xl text-center">
          <p className="text-gray-500">© 2025 K8s Platform. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
